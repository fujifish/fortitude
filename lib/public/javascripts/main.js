(function() {
  ...
  $(function() {
    ...
    function confirmAction(text, yes) {
    ...
    function modulesTableActions(index) {
      return $('<a>', {'data-module-remove': index, id: 'module-remove-' + index, href: '#'})
        .append($('<i>', {class: 'glyphicon glyphicon-remove'})).prop('outerHTML');
    }
    ...
    $('#copt-current-to-planned-button').on('click', function() {
      var node = HB.STATE.nodes.node;
