(function() {
  ...
  $(function() {
    ...
    function updateNodeCommandsTable(commands) {
      ...
      table.bootstrapTable({
        ...
        data: commands.map(function(obj) {
          return {type: obj.type, action: obj.action, status: obj.status, details: commandDetails(obj), created: obj.created, obj: obj};
        }),
        cardView: false,
        sortName: 'created',
        sortOrder: 'desc',
    ...
    function buildNodeActions(obj) {
      ...
      return div.append(remove).append(update).prop('outerHTML');
    }
